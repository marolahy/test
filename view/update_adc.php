            ...
            <div class="widget-content">
                <div class="widget big-stats-container">
                    <div class="widget-content">
                        ...
                        <form id="edit-profile" class="form-horizontal"  method="post" action="controller/adc.php?action=update">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" for="id_exercice">Exercice</label>
                                    <div class="controls">
                                        <input type="hidden" name="id" value="<?php echo $adc->id ?>" />
                                        <select class="span6" id="id_exercice" name="id_exercice" required>
                                            <?php
                                            foreach($all_exercice as $exercice) {
                                                ?>
                                                <option <?php echo $adc->id_exercice ==$exercice['id'] ? 'selected': '' ?> value="<?php echo $exercice['id'] ?>"><?php echo $exercice['annee'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_convention" name="id_convention" required>
                                            <?php
                                            foreach($all_convention as $convention) {
                                                ?>
                                                <option <?php echo $adc->id_convention == $convention['id'] ? 'selected': '' ?> value="<?php echo $convention['id'] ?>"><?php echo $convention['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_programme" name="id_programme" required>
                                            ...
                                            foreach($all_programme as $programme) {
                                                ?>
                                                <option <?php echo $adc->id_programme ==$programme['id'] ? 'selected': '' ?> value="<?php echo $programme['id'] ?>"><?php echo $programme['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_soa" name="id_soa" required>
                                            ...
                                            foreach($all_soa as $soa) {
                                                ?>
                                                <option <?php echo $adc->id_soa ==$soa['id'] ? 'selected': '' ?> value="<?php echo $soa['id'] ?>"><?php echo $soa['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_mission" name="id_mission" required>
                                            ...
                                            foreach($all_mission as $mission) {
                                                ?>
                                                <option <?php echo $adc->id_mission ==$mission['id'] ? 'selected': '' ?> value="<?php echo $mission['id'] ?>"><?php echo $mission['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_category" name="id_category" required>
                                            ...
                                            foreach($all_category as $category) {
                                                ?>
                                                <option <?php echo $adc->id_category ==$category['id'] ? 'selected': '' ?> value="<?php echo $category['id'] ?>"><?php echo $category['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_compte" name="id_compte" required>
                                            ...
                                            foreach($all_compte as $compte) {
                                                ?>
                                                <option <?php echo $adc->id_compte ==$compte['id'] ? 'selected': '' ?> value="<?php echo $compte['id'] ?>"><?php echo $compte['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_financement" name="id_financement" required>
                                            ...
                                            foreach($all_financement as $financement) {
                                                ?>
                                                <option <?php echo $adc->id_financement == $financement['id'] ? 'selected': '' ?> value="<?php echo $financement['id'] ?>"><?php echo $financement['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_ordonateur" name="id_ordonateur" required>
                                            ...
                                            foreach($all_ordonateur as $ordonateur) {
                                                ?>
                                                <option <?php echo $adc->id_ordonateur ==$ordonateur['id'] ? 'selected': '' ?> value="<?php echo $ordonateur['id'] ?>"><?php echo $ordonateur['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="controls">
                                        <select class="span6" id="id_ministere" name="id_ministere" required>
                                            ...
                                            foreach($all_ministere as $ministere) {
                                                ?>
                                                <option <?php echo $adc->id_ministere ==$ministere['id'] ? 'selected': '' ?> value="<?php echo $ministere['id'] ?>"><?php echo $ministere['code'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6" id="num_mandat" value="<?php echo $adc->num_mandat ?>" name="num_mandat" required>
                                    </div> <!-- /controls -->
                                </div> <!-- /control-group -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php
                                            $tmp_date = explode('-',$adc->date );
                                            $date = $tmp_date[2].'-'.$tmp_date[1].'-'.$tmp_date[0];
                                        ?>
                                        <input type="text" id="date" class="span6" id="label" value="<?php echo $date ?>" name="date"  required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="montant" class="span6" id="label" value="<?php echo $adc->montant ?>" name="montant"  required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="objet" class="span6" id="label" value="<?php echo $adc->objet ?>" name="objet"  required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="code_assignataire" class="span6" id="label" value="<?php echo $adc->code_assignataire ?>" name="code_assignataire"  required>
